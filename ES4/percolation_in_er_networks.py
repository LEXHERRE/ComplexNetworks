...
def get_susceptibility(component_size_distribution):
    ...
    #TODO: Implement this function
    n_max = -1
    for n in component_size_distribution:
        f = component_size_distribution[n]
        numerator += (n**2)*f
        denominator += n*f
...
def ER_percolation(N, maxk, stepsize=0.1):
    ...
    ax2.set_ylabel('Suceptibility')  # TODO: label the axis!
