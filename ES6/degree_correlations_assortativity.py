...
def calculate_average_y_for_each_unique_x_value(x_values, y_values):
    ...
    """
    ### TIP: #TODO: make an array of uniqe x-values. This array will be used to compute average of y-values corresponding to each unique x-value.
    ### TIP: unique_x_values = np.array([]) # replace
    # YOUR CODE HERE
...
if __name__ == '__main__':
    ...
    heatmap_figure_base = '' # replace, where to save the heatmap
    nearest_neighbor_figure_base = '' # replace, where to save nearest neighbor figure
